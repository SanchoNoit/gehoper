...
public class ConfiguracionPorJava {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Environment env,
		...
		em.setMappingResources("jpa/EmpleadoBase.orm.xml",
							   "jpa/Asignacion.orm.xml",
							   "jpa/EmpleadoLaboral.orm.xml",
							   "jpa/EmpleadoPracticas.orm.xml",
							   "jpa/TurnoBase.orm.xml"); // para escanear archivos xml
